---
name: blender-video-asset-sourcing
...
Use [Blender Video](../blender-video-tools/SKILL.md) to detect the exact runtime and available importers. Support in one Blender version does not prove support in another; test a representative import/render before preparing a large asset set.
...
| Music and effects | Audition for tone, pacing, transitions, and a usable ending before fitting the whole edit. Waveforms and loudness meters do not establish musical fit. Route mixing to [Audio & Sound Design](../blender-video-audio-sound-design/SKILL.md); disclose if listening is unavailable. |
...
| LUTs | Establish expected input/output color spaces before applying. Route to [Color & Finishing](../blender-video-color-finishing/SKILL.md); avoid duplicate transforms and blind preset application. |
