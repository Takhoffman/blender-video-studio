---
name: blender-vt-video-review-delivery
...
For Blender execution and UI setup use [Blender Video](../blender-vt-video/SKILL.md). For mixing problems use [Audio & Sound Design](../blender-vt-audio-sound-design/SKILL.md). Never expand review into publishing or destructive cleanup without authorization.
