...
For end-to-end coordination use [Production Workflow](../blender-vse-production-workflow/SKILL.md). For exposure correction, shot matching, grading, and mixed footage/3D color pipelines use [Color & Finishing](../blender-vse-color-finishing/SKILL.md).
