---
name: blender-vse-video-review-delivery
...
For Blender execution and UI setup use [Blender Video](../blender-vse-video/SKILL.md). For color discrepancies use [Color & Finishing](../blender-vse-color-finishing/SKILL.md). For mixing problems use [Audio & Sound Design](../blender-vse-audio-sound-design/SKILL.md). Never expand review into publishing or destructive cleanup without authorization.
